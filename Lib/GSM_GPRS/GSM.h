...
/*
http://www.open-electronics.org/arduino-gsm-shield/2/
*/
...
enum call_ret_val_enum
	...
	CALL_NO_RESPONSE,
	CALL_COMM_LINE_BUSY,
	CALL_VOICE_CONNECTING,//Исходящий голосовой звонок - идет подключение
...
class GSM
{
  ...
  public:
	...
	void SetModemSleepMode(bool mode);
	...
	char GetPhoneNumberName(byte position, char *phone_number, char *phone_name);
