...
/*******************************************************************************
					Чтение СМС в формате PDU
value:
	msg - указатель на возвращаемый результат с текстом PDU
	msglength - размер буфера
	number - номер СМС в памяти на SIM карте
return:
	true	 - чтение выполнено успешно
	false - не удалось прочитать смс (не верный номер сообщения 
		или СМС по данонму адресу отсутствует)
*******************************************************************************/
...
/*******************************************************************************
					Выполнение CUSD запроса
value:
	msg - указатель на возвращаемый результат запроса
	msglength - размер буфера
	number - номер для запроса CUSD, передается только число без символов * и #
return:
...
/*******************************************************************************
		Выполнение CUSD запроса на заданный номер
value:
	number - строка с номером для запроса CUSD
return:
	true	 - запрос выполнен успешно
	false - запрос не выполнен
*******************************************************************************/
...
/*******************************************************************************
				Запрос имени оператора с СИМ карты
value:
	msg - указатель на возвращаемый результат запроса
	msglength - размер буфера
return:
...
/*******************************************************************************
				Запрос текущего времени с модема
value:
	msg - указатель на возвращаемый результат запроса
	msglength - размер буфера
return:
